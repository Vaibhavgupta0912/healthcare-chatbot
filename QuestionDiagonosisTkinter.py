...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        ...
        self.lblQuestion=Label(self,text="Symptoms",width=13,bg="bisque", font=20)
        self.lblQuestion.grid(row=0,column=0,rowspan=4)

        self.lblDigonosis = Label(self, text="Digonosis",width=13,bg="bisque", font=20)
        self.lblDigonosis.grid(row=4, column=0,sticky="n",pady=5)

        # self.varQuestion=StringVar()
        self.txtQuestion = Text(self, width=140,height=7)
        self.txtQuestion.grid(row=0, column=1,rowspan=4,columnspan=20)

        self.varDiagonosis=StringVar()
        self.txtDigonosis =Text(self, width=140,height=20)
        self.txtDigonosis.grid(row=4, column=1,columnspan=20,rowspan=20,pady=5)

        self.btnNo=Button(self,text="No",width=13,bg="bisque", font=6, command=self.btnNo_Click)
        self.btnNo.grid(row=25,column=0)
        self.btnYes = Button(self, text="Yes",width=13,bg="bisque",font=6, command=self.btnYes_Click)
        self.btnYes.grid(row=25, column=1,columnspan=20,sticky="e")

        self.btnClear = Button(self, text="Clear",width=13,bg="bisque",font=6, command=self.btnClear_Click)
        self.btnClear.grid(row=27, column=0)
        self.btnStart = Button(self, text="Start",width=13,bg="bisque",font=6, command=self.btnStart_Click)
...
#        self.txtDigonosis.insert(END,str1+"\n")
    ...
    def btnStart_Click(self):
        ...
        self.txtDigonosis.delete(0.0,END)
        self.txtQuestion.delete(0.0,END)
        self.txtDigonosis.insert(END,"Welcome in HealthCare AVS ChatBot" + "\n" + "\n") 
        self.txtDigonosis.insert(END,"Please Click on Yes or No for the Above Symptoms")                  
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblMsg=Label(self, text=" ", width="300", height="2", font=("Calibri", 13))
        self.lblMsg.pack()
        self.lblMsg=Label(self, text="HealthCare AVS ChatBot", bg="light blue", width="300", height="1", font=("PosterBodoni BT", 26 ,"bold italic"))
        self.lblMsg.pack()
        self.lblMsg=Label(self, text=" ", width="300", height="2", font=("Calibri", 13))
        self.lblMsg.pack()
        
        self.lblMsg=Label(self, text="Select Your Choice",  width="300", height="2", font=("Calibri", 17))
        self.lblMsg.pack()
        
    
        
        self.btnLogin=Button(self, text="Login", height="2", width="30", font = ("Calibri" , 15, "bold italic"),bg="pink", command=self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="2", width="30",font = ("Calibri" , 15 ,"bold italic"),bg="orange", command=self.btnRegister_Click)
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="" ,  font = ("times" , 22, "bold"))
        self.lblMsg.pack()
        self.lblMsg=Label(self, text="HealthCare AVS ChatBot", bg="light blue", width="300", height="1",  font = ("times" , 26, "bold italic"))
        self.lblMsg.pack()
        self.lblMsg=Label(self, text=" " ,  font = ("times" , 22, "bold"))
        self.lblMsg.pack()
        self.lblMsg=Label(self, text="Enter details below to login" ,  font = ("times" , 22, "bold"))
        self.lblMsg.pack()
        
        self.username=Label(self, text=" " , fg ="green")
        self.username.pack()
        self.username_verify = StringVar()
       
        
        self.username=Label(self, text="Username * " , fg ="green" , font = ("arial" , 13))
        self.username.pack()
        self.username_verify = StringVar()
        self.username_login_entry = Entry(self, textvariable=self.username_verify)
        self.username_login_entry.pack()
        self.password=Label(self, text="Password * ", fg ="green" , font = ("arial" , 13))
        self.password.pack()
        ...
        self.btnLogin=Button(self, text="Login", width=10, height=1,bg ="RED",fg = "white" , font = ("arial" , 14), command=self.btnLogin_Click)
        self.btnLogin.pack()
...
class SignUp(Frame):
    ...
    def createWidget(self):
        ...
        self.lblMsg=Label(self, text="HealthCare AVS Chatbot", bg="light blue" , width="300", height="1", fg = "black" , font = ("times" , 26, "bold italic"))
        self.lblMsg.pack()
        self.lblMsg=Label(self, text="" , fg = "black" , font = ("times" , 22, "bold italic"))
        self.lblMsg.pack()
        self.lblMsg=Label(self, text="Please enter details below" , fg = "black" , font = ("times" , 22, "bold"))
        self.lblMsg.pack()
        
        self.username_lable = Label(self, text=" ")
        self.username_lable.pack()
        self.username = StringVar()
       
        
        self.username_lable = Label(self, text="Username* ", fg="green", font = ("arial" , 12))
        self.username_lable.pack()
        self.username = StringVar()
        self.username_entry = Entry(self, textvariable=self.username)
        self.username_entry.pack()
        
        self.age_lable = Label(self, text=" Age* ", fg="green", font = ("arial" , 12))
        self.age_lable.pack()
        self.age = StringVar()
        self.age_entry = Entry(self, textvariable=self.age)
        self.age_entry.pack()
        
        self.address_lable = Label(self, text=" Address* ", fg="green", font = ("arial" , 12))
        self.address_lable.pack()
        self.address = StringVar()
        self.address_entry = Entry(self, textvariable=self.address)
        self.address_entry.pack()
        
        self.email_lable = Label(self, text="Email* ", fg="green", font = ("arial" , 12))
        self.email_lable.pack()
        self.email = StringVar()
        self.email_entry = Entry(self, textvariable=self.email)
        self.email_entry.pack()
        
        self.phone_lable = Label(self, text="Phone Number* ", fg="green", font = ("arial" , 12))
        self.phone_lable.pack()
        self.phone = StringVar()
        self.phone_entry = Entry(self, textvariable=self.phone)
        self.phone_entry.pack()

        self.password_lable = Label(self, text="Password* ", fg="green", font = ("arial" , 12))
        ...
        self.btnRegister=Button(self, text="Register", width=10, height=1, bg="red",fg="white", font = ("arial" , 14),command=self.register_user)
        self.btnRegister.pack()
